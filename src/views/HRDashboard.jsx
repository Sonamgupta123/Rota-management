...
const HRDashboard = () => {
  const { employees, documents, leave, onboardEmployee, setCurrentView } = useApp();
    ...
    <div className="space-y-6 animate-fade-in p-2">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="glass-card rounded-3xl p-5 space-y-4">
          <div className="border-b border-slate-105 dark:border-slate-800 pb-2 flex items-center justify-between">
      ...
      {onboardOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fade-in">
          <div className="w-full max-w-lg rounded-3xl glass-modal p-6 md:p-8 shadow-xl relative animate-slide-up">
