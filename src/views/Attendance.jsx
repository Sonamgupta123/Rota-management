                      ...
                      return (
                        <tr key={log.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/10 transition-colors">
                          ...
                          <td className="p-3">
                            ...
                            {log.latitude && (
                              <div className="flex items-center gap-1.5 mt-0.5 text-[9px] font-bold text-slate-450 dark:text-slate-550">
              ...
              <div className="space-y-1.5 z-10 w-full flex flex-col items-center">
                ...
                <div className="my-8 relative z-10">
                  <div 
                    ...
                    className={`h-64 w-64 md:h-80 md:w-80 rounded-full flex flex-col items-center justify-center bg-white dark:bg-slate-955 shadow-2xl relative transition-all duration-305 cursor-pointer overflow-hidden group select-none
                  ...
                  >
                    ...
                    {clockState.status === 'Clocked In' && (
                      <div className="absolute inset-0 bg-red-650/95 text-white flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 pointer-events-none">
                        ...
                        <span className="text-[9px] text-red-250 mt-0.5">Click to end session</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className={`w-full max-w-md rounded-2xl border p-4 text-left transition-all duration-305 mt-2 space-y-3 ${
                ...
                <div className="w-full space-y-3 mt-6 mb-6 z-10 max-w-md">
                  ...
                  {clockState.latitude && (
                    <div className="w-full border border-emerald-500/20 dark:border-emerald-800/40 rounded-2xl p-3 bg-emerald-50/10 dark:bg-emerald-955/5 text-left text-xs font-semibold space-y-1">
                      <span className="text-[8px] font-black text-slate-450 dark:text-slate-555 block uppercase tracking-wider">Logged Punch Location</span>
            ...
            <div className="glass-card rounded-3xl p-5 space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[11px] text-left border-collapse">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-855 text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider text-[9px]">
