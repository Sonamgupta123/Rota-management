...
const RotaManagement = () => {
  ...
  return (
    <div className="space-y-5 animate-fade-in p-1 max-w-[1600px] mx-auto relative min-h-[calc(100vh-120px)]">
                    ...
                    return (
                      ...
                      >
                        <div className="border-b border-slate-100 dark:border-slate-900 pb-1 mb-1">
                          ...
                          {hasNotes ? (
                            <div className="mt-1 flex items-center gap-1 text-[10px] font-bold text-brand-650 dark:text-brand-400 bg-brand-50/80 dark:bg-brand-950/30 px-1.5 py-0.5 rounded-md border border-brand-100 dark:border-brand-900/40 w-fit">
                              <span>📌</span>
                      ...
                      return (
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center justify-between text-[9px] font-bold text-slate-450 dark:text-slate-500 pb-1 border-b border-slate-50 dark:border-slate-900/50 mb-1.5 select-none">
                              <span>Target: 3</span>
                            ...
                            {cellShifts.map((sh) => {
                              ...
                              return (
                                <div 
                                  ...
                                  className="relative flex flex-col gap-1 rounded-lg border border-slate-105 dark:border-slate-850 p-1.5 shadow-sm bg-white dark:bg-slate-900/80 text-[10px] font-medium transition-all hover:shadow-md"
                                >
                            ...
                            {cellShifts.length === 0 && currentRole !== 'Employee' && currentRole !== 'Receptionist' && (
                              <div className="flex h-10 items-center justify-center border border-dashed border-slate-200 dark:border-slate-800 rounded-xl text-slate-450 dark:text-slate-500 hover:text-brand-650 hover:bg-brand-50/50 hover:border-brand-300 dark:hover:bg-brand-950/20 dark:hover:border-brand-800/80 transition-all cursor-pointer select-none">
                            ...
                            {cellShifts.length > 0 && currentRole !== 'Employee' && currentRole !== 'Receptionist' && (
                              <button
                                ...
                                className="w-full flex items-center justify-center gap-1 py-1 mt-1.5 rounded-lg border border-dashed border-slate-200 dark:border-slate-800 text-[9px] font-bold text-slate-450 hover:text-brand-650 hover:bg-brand-50/50 hover:border-brand-300 dark:hover:bg-brand-950/20 dark:hover:border-brand-800/80 transition-all select-none"
                              >
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[9px] text-slate-450 truncate mt-0.5">{emp.title}</p>
                          </div>
                        </div>
      ...
      {dayDetailsOpen && (
        <div className="absolute -inset-4 md:-inset-6 z-40 bg-slate-50 dark:bg-slate-950 flex items-start justify-center p-4 md:p-6 overflow-y-auto min-h-full">
          <div className="w-full max-w-lg rounded-2xl border border-slate-205 dark:border-slate-800 p-5 shadow-2xl relative bg-white dark:bg-slate-900 my-4 animate-slide-up">
            <button 
            ...
            <div className="border-t border-slate-100 dark:border-slate-800 pt-4 mt-4 space-y-4">
              ...
              <div className="space-y-2 mt-4 bg-slate-50/20 dark:bg-slate-900/10 p-3 rounded-xl border border-slate-100 dark:border-slate-850">
                <h5 className="text-[10px] font-bold text-slate-450 dark:text-slate-500 uppercase tracking-wider">
                  Coverage Timeline
                </h5>
              ...
              <div className="space-y-1.5 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
                {dayShifts.length === 0 ? (
                  ...
                  dayShifts.map(sh => {
                    ...
                    if (!emp) return null;
                    return (
                      <div key={sh.id} className="flex items-center justify-between p-2 rounded-xl border border-slate-105 bg-slate-50/20 dark:bg-slate-900/10 text-xs">
                        <div className="flex items-center gap-2">
              ...
              <div className="space-y-1.5 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
                {(() => {
                  ...
                  return employeesOnLeave.map(l => (
                    <div key={l.id} className="flex items-center justify-between p-2 rounded-xl border border-slate-105 bg-amber-50/10 dark:bg-amber-950/5 text-xs">
                      <div className="flex items-center gap-2">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fade-in">
          <div className="w-full max-w-md rounded-2xl glass-modal p-5 shadow-2xl relative animate-slide-up bg-white">
            ...
            <form onSubmit={handleSaveNote} className="mt-4 space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="font-bold text-slate-555 block">Note Type</label>
                  <select
                    value={noteType}
              ...
              {noteType === 'Other' && (
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="h-10 w-full rounded-xl border border-slate-205 bg-slate-50 px-3 dark:border-slate-800 dark:bg-slate-900 dark:text-white outline-none focus:border-brand-500 focus:bg-white font-semibold"
                  />
                </div>
              )}
