...
import { 
  ...
  ShieldAlert, FileClock, Trash2, ArrowLeft, Send, CheckCircle2, AlertTriangle, FileSpreadsheet, X
} from 'lucide-react';
            ...
            <div className="glass-card rounded-2xl p-6 shadow-sm relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 text-xs border-t border-slate-100 dark:border-slate-800 pt-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-extrabold text-slate-800 dark:text-slate-250">{selectedObs.assignedStaff || 'Not Assigned'}</p>
                </div>
              </div>
            ...
            <div className="glass-card rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-3 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                {(!selectedObs.notesHistory || selectedObs.notesHistory.length === 0) ? (
                  <p className="text-xs text-slate-400 italic py-2">No historical notes logged on this observation.</p>
                ) : (
            ...
            <div className="glass-card rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                {(!selectedObs.attachments || selectedObs.attachments.length === 0) ? (
                  <p className="text-xs text-slate-400 italic py-2 sm:col-span-2">No attachments uploaded yet.</p>
                ) : (
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card rounded-2xl p-5 shadow-sm">
              ...
              {selectedObs.followUpRequired ? (
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 dark:bg-slate-900/40 dark:border-slate-800 text-xs text-slate-400 italic">
