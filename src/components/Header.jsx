      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-xl p-1 hover:bg-slate-50 dark:hover:bg-slate-900 border border-transparent hover:border-slate-200/60 dark:hover:border-slate-800/80 transition-all"
          >
            <img
              src={activeEmp.photo}
              alt={activeEmp.name}
            ...
            <div className="absolute right-0 mt-2 w-56 rounded-2xl glass-modal py-1.5 shadow-xl ring-1 ring-slate-900/5 z-50 animate-slide-up">
              ...
              <div className="p-1">
                <button 
                  ...
                  className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 text-left text-xs font-semibold text-red-650 hover:bg-red-50 hover:text-red-750 dark:text-red-400 dark:hover:bg-red-500/10 dark:hover:text-red-400 transition-all"
                >
